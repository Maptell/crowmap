			   ...
			   properties['EXTENT']=minx + " " + miny + " " + maxx + " " + maxy;
                ...
                this.response.push(nmap);
                  ...
                  properties['MINFEATURESIZE']=sizex + " " + sizey;
                   ...
                   var g=this.tokens.shift();
                   var b=this.tokens.shift();
                   properties[elm1]=r+" "+g+ " "+b;
	...
	parseStyle:function(pid)
	{
		...
		do{
			...
			if(elmc=='COLORRANGE'){
                 ...
                 var id=this.counter++;
                var nmap={ "name" : "Pattern"+id,"title":"Pattern", "parent":"Style"+pid, "type": "Pattern" ,"code":id , "properties":r};
                this.response.push(nmap); 
			}else if(elmc=='POSITION'){
                   var val=this.tokens.shift();
                   properties[elm1]=val;
