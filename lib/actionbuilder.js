...
{title:"Interlace",value:"0",id:"interlace",enabled:"0",type:"switch"},{title:"MaxSize",value:"0",id:"maxsize",enabled:"0",type:"textbox"},
...
{title:"Transparent",value:"0",id:"transparent",enabled:"0",type:"switch"},{title:"Units",value:"0",id:"units",enabled:"0",type:"dropdown",doptions:"dd|feet|inches|kilometers|meters|miles|nauticalmiles"}];
...
"Imagecolor":"#FFFFFF","Imagequality":"","Imagetype":"","Interlace":"","Maxsize":"2048","Name":"","Resolution":"","Scaledenom":"",
...
"Maxgeowidth":"","Maxscaledenom":"","Metadata":"","mingeowidth":"","Minscaledenom":"","Name":"","Offsite":"","Opacity":"",
...
"METADATA":"","Minscaledenom":"3000","Minscale":"","Mintemplate":"","Queryformat":"text/html","Template":"","Temppath":""},
OutputFormat:{"Driver":"","Extension":"png","Formatoption":"GAMMA=0.75","Imagemode":"rgb","Mimetype":"image/png",
"Name":"png","Transparent":"on"},
Legend:{"Imagecolor":"","Interlace":"ON","$KEYSIZE&x":"20","$KEYSIZE&y":"10","$KEYSPACING&x":"5","$KEYSPACING&y":"5","Outlinecolor":"",
...
Class:{"Backgroundcolor":"","Color":"","Debug":"","Expression":"","Group":"","Keyimage":"","Maxscaledenom":"",
"Maxsize":"","Minscaledenom":"","Minsize":"","Name":"","Outlinecolor":"","Size":"","Status":"","Symbol":"","Template":"","Text":""},
...
"Name":"","Points":"","Transparent":"","Type":""},Feature:{"Points":"","Items":"","Text":"","Wkt":""},Outputformat:{}};
...
// console.log(loadArr);
    ...
    for (var i = initialval; i < limitval; i++) {
        ...
        if (values.type == "textbox") {
            ...
            var trtemp = tr.append('td').append("div").attr("class", "onoffswitch");
            if(loadVal=="on"){
                trtemp.append("input").attr("type", "checkbox").attr("name", values.id).attr("checked", "true").attr("class", "onoffswitch-checkbox").attr("id", values.id);
            }else{
                trtemp.append("input").attr("type", "checkbox").attr("name", values.id).attr("class", "onoffswitch-checkbox").attr("id", values.id);
            }
   ...
   function addActionBar(actions,ptype,element)
   {
   	 ...
   	 d3.select(".popover-title").append("div").attr("class","action_bar");
   	 {
   	 	...
   	 	for(i=0;i<actions.length;i++){
   	    	var p=d3.select(".action_bar").append("div");
   	    	p.append("span").attr("class","mtooltiptext").html(actions[i]);
   	    	p.attr("class","mtooltip action_"+actions[i]).on("click",function (d,q)
   	    	{
   	    		var t=d3.select(this).attr("class").split("_");

   	    		addNode(t[1],current,t[1],ptype);

   	    		 getNodePropsValues(ptype);
   	    	}
   	    	);
   	 	}
   	 }
...
function setMaxID()
{
	  ...
	  for(var k=0;k<data.length;k++){
	  		...
	  		console.log("ITEMCOUNTER"+ITEMCOUNTER +":"+maxval);
