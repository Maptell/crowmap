...
var ACTIVEPROPERTY;
   ...
   var LOOKUP={EXTENT:["minx","miny","maxx","maxy"],SIZE:["x","y"],POINTS:["x","y"],KEYSIZE:["x","y"],KEYSPACING:["x","y"],BACKGROUNDSHADOWSIZE:["x","y"],OFFSET:["x","y"],SHADOWSIZE:["x","y"]};
...
var DATABUFFER = "";
         ...
         function generateMapFile() {
               ...
               DEPTH = 0;
             str(data[0]);console.log(DATABUFFER);
             return DATABUFFER;
         }
