...
{title:"Size",id:"size",enabled:"0",type:"label"},{title:"X",id:"$SIZE&x",enabled:"0",type:"textbox",vstring:{regex:"[^0-9]",required:"true"},tooltip:"Size in pixels of the output image (i.e. the map)."},
...
{title:"Points",id:"points",enabled:"0",type:"label"},
{title:"X",id:"$POINTS&x",enabled:"0",type:"textbox",vstring:{regex:"[^0-9]",required:"true"},tooltip:"Signifies the start of a sequence of points that make up a symbol of TYPE vector or that define the x and y radius of a symbol of TYPE ellipse. "},
{title:"Y",id:"$POINTS&y",enabled:"0",type:"textbox",vstring:{regex:"[^0-9]",required:"true"},tooltip:"Signifies the start of a sequence of points that make up a symbol of TYPE vector or that define the x and y radius of a symbol of TYPE ellipse. "},
...
QueryMap:{"Color":"#FFFFFF","$SIZE&x":"","$SIZE&y":"","Status":"","Style":""},
Reference:{"Color":"#FFFFFF","$EXTENT&minx":"67.429360","$EXTENT&miny":"5.758329","$EXTENT&maxx":"98.067696","$EXTENT&maxy":"38.010637",
"Image":"","Marker":"","Markersize":"","Minboxsize":"","Maxboxsize":"","Outlinecolor":"#FFFFFF","$SIZE&x":"180","$SIZE&y":"140","Status":"off"},
...
Outputformat:{"driver":"","extension":"","formatoption":"","imagemode":"","mimetype":"","name":"","transparent":""},
Projection:{"proj4":""},
Querymap:{"color":"#FFFFFF","$SIZE&x":"","$SIZE&y":"","status":"","style":""}};
