  ...
  function addPropertyLayer(arrayVal,name)
   {
       ...
       addTab("5",arrayVal,"40","49",name);
       addTab("6",arrayVal,"49",arrayVal.length,name);
       showTab();
   }
...
function appendText(classname) {
	var container="tr" + classname;
    var numItems = $('.'+classname).length+1;
    var kp="onkeyup=keypressed('" + classname +"key"+numItems+ "')";
    var vp="onkeyup=keypressed('" + classname +"value"+numItems+ "')";
